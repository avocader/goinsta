...
const (
	...
	defaultDevice        = "samsung_galaxy_s7"
)

type device struct {
	InstagramVersion string `json:"instagram_version"`
...
var devices = map[string]device{
	...
	"samsung_galaxy_s9_plus": {
		InstagramVersion: "96.0.0.28.114",
		AndroidVersion:   "24",
		AndroidRelease:   "7.0",
		Dpi:              "640dpi",
		Resolution:       "1440x2560",
		...
		Device:           "SM-G965F",
		Model:            "tar2qltecs",
		Cpu:              "amsungexynos9810",
	},
	"xiaomi_mi_mix_3": {
		InstagramVersion: "107.0.0.21.121",
		AndroidVersion:   "28",
		AndroidRelease:   "9.0",
		Dpi:              "360dpi",
